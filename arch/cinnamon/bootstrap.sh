...
proot-distro login arch-cinnamon --shared-tmp -- /bin/sh -c 'kill -9 $(pgrep -f "x11") 2>/dev/null'
...
# Setup arch-cinnamon
proot-distro login arch-cinnamon -- /bin/sh -c 'apt update && apt install wget -y'
