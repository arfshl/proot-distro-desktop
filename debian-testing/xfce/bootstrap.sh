...
proot-distro login debian-testing-xfce --user debian-testing-xfce' >> /data/data/com.termux/files/usr/bin/debian-testing-xfce
...
proot-distro login debian-testing-xfce --shared-tmp -- /bin/sh -c 'kill -9 $(pgrep -f "x11") 2>/dev/null'
