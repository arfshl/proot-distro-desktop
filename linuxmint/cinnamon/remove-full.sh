#!/bin/sh
proot-distro remove linuxmint-cinnamon

rm /data/data/com.termux/files/usr/bin/linuxmint-cinnamon
rm /data/data/com.termux/files/usr/bin/linuxmint-cinnamon-x11
