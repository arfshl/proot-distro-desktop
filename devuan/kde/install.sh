...
sudo adduser --disabled-password --gecos "devuan-kde" devuan-kde && echo 'devuan-kde:123' | chpasswd && echo 'devuan-kde ALL=(ALL:ALL) ALL' >> /etc/sudoers.d/user

# Setup VNC server
# Create VNC configuration directory
mkdir -p /home/devuan-kde/.vnc

# Create VNC password file (default 1234567890)
printf "1234567890" | vncpasswd -f > /home/devuan-kde/.vnc/passwd
chmod 600 /home/devuan-kde/.vnc/passwd
...
export DISPLAY=:0
dbus-launch --exit-with-session startplasma-x11' >> /home/devuan-kde/.vnc/xstartup

# Create script for starting VNC server
echo '#!/bin/sh
export USER=devuan-kde
export HOME=/home/devuan-kde
...
export HOME=/home/devuan-kde
vncserver -kill :0
rm -rf /home/devuan-kde/.vnc/localhost:0.pid
rm -rf /tmp/.X0-lock
...
chmod +x restartvnc
cd
chmod +x /home/devuan-kde/.vnc/xstartup
