...
sudo adduser --disabled-password --gecos "devuan-lxqt" devuan-lxqt && echo 'devuan-lxqt:123' | chpasswd && echo 'devuan-lxqt ALL=(ALL:ALL) ALL' >> /etc/sudoers.d/user

# Setup VNC server
# Create VNC configuration directory
mkdir -p /home/devuan-lxqt/.vnc

# Create VNC password file (default 1234567890)
printf "1234567890" | vncpasswd -f > /home/devuan-lxqt/.vnc/passwd
chmod 600 /home/devuan-lxqt/.vnc/passwd
...
export DISPLAY=:0
dbus-launch --exit-with-session startlxqt' >> /home/devuan-lxqt/.vnc/xstartup

# Create script for starting VNC server
echo '#!/bin/sh
export USER=devuan-lxqt
export HOME=/home/devuan-lxqt
...
export HOME=/home/devuan-lxqt
vncserver -kill :0
rm -rf /home/devuan-lxqt/.vnc/localhost:0.pid
rm -rf /tmp/.X0-lock
...
chmod +x restartvnc
cd
chmod +x /home/devuan-lxqt/.vnc/xstartup
