...
sudo adduser --disabled-password --gecos "devuan-cinnamon" devuan-cinnamon && echo 'devuan-cinnamon:123' | chpasswd && echo 'devuan-cinnamon ALL=(ALL:ALL) ALL' >> /etc/sudoers.d/user

# Setup VNC server
# Create VNC configuration directory
mkdir -p /home/devuan-cinnamon/.vnc

# Create VNC password file (default 1234567890)
printf "1234567890" | vncpasswd -f > /home/devuan-cinnamon/.vnc/passwd
chmod 600 /home/devuan-cinnamon/.vnc/passwd
...
export DISPLAY=:0
dbus-launch --exit-with-session cinnamon-session' >> /home/devuan-cinnamon/.vnc/xstartup

# Create script for starting VNC server
echo '#!/bin/sh
export USER=devuan-cinnamon
export HOME=/home/devuan-cinnamon
...
export HOME=/home/devuan-cinnamon
vncserver -kill :0
rm -rf /home/devuan-cinnamon/.vnc/localhost:0.pid
rm -rf /tmp/.X0-lock
...
chmod +x restartvnc
cd
chmod +x /home/devuan-cinnamon/.vnc/xstartup
