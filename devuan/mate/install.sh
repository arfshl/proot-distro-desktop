...
sudo adduser --disabled-password --gecos "devuan-mate" devuan-mate && echo 'devuan-mate:123' | chpasswd && echo 'devuan-mate ALL=(ALL:ALL) ALL' >> /etc/sudoers.d/user

# Setup VNC server
# Create VNC configuration directory
mkdir -p /home/devuan-mate/.vnc

# Create VNC password file (default 1234567890)
printf "1234567890" | vncpasswd -f > /home/devuan-mate/.vnc/passwd
chmod 600 /home/devuan-mate/.vnc/passwd
...
export DISPLAY=:0
dbus-launch --exit-with-session mate-session' >> /home/devuan-mate/.vnc/xstartup

# Create script for starting VNC server
echo '#!/bin/sh
export USER=devuan-mate
export HOME=/home/devuan-mate
...
export HOME=/home/devuan-mate
vncserver -kill :0
rm -rf /home/devuan-mate/.vnc/localhost:0.pid
rm -rf /tmp/.X0-lock
...
chmod +x restartvnc
cd
chmod +x /home/devuan-mate/.vnc/xstartup
