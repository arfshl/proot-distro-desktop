...
sudo adduser --disabled-password --gecos "devuan-lxde" devuan-lxde && echo 'devuan-lxde:123' | chpasswd && echo 'devuan-lxde ALL=(ALL:ALL) ALL' >> /etc/sudoers.d/user

# Setup VNC server
# Create VNC configuration directory
mkdir -p /home/devuan-lxde/.vnc

# Create VNC password file (default 1234567890)
printf "1234567890" | vncpasswd -f > /home/devuan-lxde/.vnc/passwd
chmod 600 /home/devuan-lxde/.vnc/passwd
...
export DISPLAY=:0
dbus-launch --exit-with-session startlxde' >> /home/devuan-lxde/.vnc/xstartup

# Create script for starting VNC server
echo '#!/bin/sh
export USER=devuan-lxde
export HOME=/home/devuan-lxde
...
export HOME=/home/devuan-lxde
vncserver -kill :0
rm -rf /home/devuan-lxde/.vnc/localhost:0.pid
rm -rf /tmp/.X0-lock
...
chmod +x restartvnc
cd
chmod +x /home/devuan-lxde/.vnc/xstartup
