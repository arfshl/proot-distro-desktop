...
sudo adduser --disabled-password --gecos "devuan-xfce" devuan-xfce && echo 'devuan-xfce:123' | chpasswd && echo 'devuan-xfce ALL=(ALL:ALL) ALL' >> /etc/sudoers.d/user

# Setup VNC server
# Create VNC configuration directory
mkdir -p /home/devuan-xfce/.vnc

# Create VNC password file (default 1234567890)
printf "1234567890" | vncpasswd -f > /home/devuan-xfce/.vnc/passwd
chmod 600 /home/devuan-xfce/.vnc/passwd
...
export DISPLAY=:0
dbus-launch --exit-with-session startxfce4' >> /home/devuan-xfce/.vnc/xstartup

# Create script for starting VNC server
echo '#!/bin/sh
export USER=devuan-xfce
export HOME=/home/devuan-xfce
...
export HOME=/home/devuan-xfce
vncserver -kill :0
rm -rf /home/devuan-xfce/.vnc/localhost:0.pid
rm -rf /tmp/.X0-lock
...
chmod +x restartvnc
cd
chmod +x /home/devuan-xfce/.vnc/xstartup
