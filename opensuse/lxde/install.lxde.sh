...
sudo useradd -m opensuse-lxde && echo 'opensuse-lxde:123' | chpasswd && echo 'opensuse-lxde ALL=(ALL:ALL) ALL' >> /etc/sudoers.d/user


# Setup VNC server
# Create VNC configuration directory
mkdir -p /home/opensuse-lxde/.vnc

# Create VNC password file (default 1234567890)
printf "1234567890" | vncpasswd -f > /home/opensuse-lxde/.vnc/passwd
chmod 600 /home/opensuse-lxde/.vnc/passwd
