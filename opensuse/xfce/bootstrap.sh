...
proot-distro login opensuse-xfce -- /bin/sh -c 'wget https://raw.githubusercontent.com/arfshl/proot-distro-desktop/refs/heads/main/opensuse/xfce/install-xfce.sh -O install-xfce.sh && chmod +x install-xfce.sh && ./install-xfce.sh'
