...
mkdir -p /home/fedora-xfce/.vnc

# Create VNC password file (default 1234567890)
printf "1234567890" | vncpasswd -f > /home/fedora-xfce/.vnc/passwd
chmod 600 /home/fedora-xfce/.vnc/passwd
...
export DISPLAY=:0
dbus-launch --exit-with-session startxfce4' >> /home/fedora-xfce/.vnc/xstartup

# Create script for starting VNC server
echo "#!/bin/sh
export USER=fedora-xfce
export HOME=/home/fedora-xfce
...
export HOME=/home/fedora-xfce
vncserver -kill :0
rm -rf /home/fedora-xfce/.vnc/localhost:0.pid
rm -rf /tmp/.X0-lock
...
chmod +x restartvnc
cd
chmod +x /home/fedora-xfce/.vnc/xstartup
