...
proot-distro login fedora-mate -- /bin/sh -c 'wget https://raw.githubusercontent.com/arfshl/proot-distro-desktop/refs/heads/main/fedora/mate/install.sh -O install.sh && chmod +x install.sh && ./install.sh'
