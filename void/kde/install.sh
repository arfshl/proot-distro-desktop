...
mkdir -p /home/void-kde/.vnc

# Create VNC password file (default 1234567890)
printf "1234567890" | vncpasswd -f > /home/void-kde/.vnc/passwd
chmod 600 /home/void-kde/.vnc/passwd
...
export DISPLAY=:0
dbus-launch --exit-with-session startplasma-x11' >> /home/void-kde/.vnc/xstartup

# Create script for starting VNC server
echo "#!/bin/sh
export USER=void-kde
export HOME=/home/void-kde
...
export HOME=/home/void-kde
vncserver -kill :0
rm -rf /home/void-kde/.vnc/localhost:0.pid
rm -rf /tmp/.X0-lock
