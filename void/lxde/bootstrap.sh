...
proot-distro login void-lxde -- /bin/sh -c 'wget https://raw.githubusercontent.com/arfshl/proot-distro-desktop/refs/heads/main/void/lxde/install.sh -O install.sh && chmod +x install.sh && ./install.sh'
