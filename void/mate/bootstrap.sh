...
proot-distro install ghcr.io/void-linux/void-musl:latest --override-alias void-mate

# Setup void-mate
proot-distro run void-mate -- xbps-install -Su 
proot-distro run void-mate -- xbps-install -S wget bash -y
proot-distro login void-mate -- /bin/sh -c 'wget https://raw.githubusercontent.com/arfshl/proot-distro-desktop/refs/heads/main/void/mate/install.sh -O install.sh && chmod +x install.sh && ./install.sh'
