...
proot-distro login opensuse-tumbleweed-lxqt --shared-tmp -- /bin/sh -c 'pkill -x -9 x11 2>/dev/null'
...
PD_OVERRIDE_TARBALL_URL="https://github.com/arfshl/pd-custom-rootfs/releases/download/opensuse-tumbleweed/opensuse-tumbleweed-lxqt-$ARCH.tar.xz" PD_OVERRIDE_TARBALL_SHA256="" proot-distro install opensuse --override-alias opensuse-tumbleweed-lxqt
