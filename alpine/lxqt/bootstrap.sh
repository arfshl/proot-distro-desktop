...
proot-distro login alpine-lxqt -- /bin/sh -c 'wget https://raw.githubusercontent.com/arfshl/proot-distro-desktop/refs/heads/main/alpine/lxqt/install.sh -O install.sh && chmod +x install.sh && ./install.sh'
