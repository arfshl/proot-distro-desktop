...
proot-distro login alpine-mate -- /bin/sh -c 'wget https://raw.githubusercontent.com/arfshl/proot-distro-desktop/refs/heads/main/alpine/mate/install.sh -O install.sh && chmod +x install.sh && ./install.sh'
